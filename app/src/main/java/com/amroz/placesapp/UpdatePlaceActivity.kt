...
import kotlinx.android.synthetic.main.activity_add_news_location.type
import kotlinx.android.synthetic.main.activity_update_place.*

const val REQUEST_MAP_UPDATE=222
class UpdatePlaceActivity : AppCompatActivity() {
    ...
    lateinit var update_location:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        update_location=findViewById(R.id.update_location) as TextView
        ...
        update_location.setOnClickListener {
            ...
            startActivityForResult(intint, REQUEST_MAP_UPDATE)
